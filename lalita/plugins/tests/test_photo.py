...
class TestSet(PluginTest):
    ...
    def test_set_self(self):
        """Sets own photo."""
        self.disp.push(COMMAND, "pepe", "canal", "foto", "pepe", "url")
    ...
    def test_unset_initial(self):
        ...
        self.disp.push(COMMAND, "pepe", "canal", "foto", "pepe", "None")
    ...
    def test_set_self_twice(self):
        ...
        self.disp.push(COMMAND, "pepe", "canal", "foto", "pepe", "url1")
        self.assertEqual(self.answer[0][1], u"pepe: URL configured!")
        self.disp.push(COMMAND, "pepe", "canal",
                       "foto", "pepe", "url2")
    ...
    def test_set_twice_otheruser(self):
        ...
        self.disp.push(COMMAND, "juan", "canal", "foto", "juan", "url1")
    ...
    def test_set_baduser(self):
        ...
        self.disp.push(COMMAND, "juan", "canal", "foto", "pepe", "url1")
        self.assertEqual(self.answer[0][1],
    ...
    def test_baduser_not_affects(self):
        ...
        self.disp.push(COMMAND, "juan", "canal", "foto", "juan", "url1")
        self.disp.push(COMMAND, "pepe", "canal", "foto", "pepe", "url2")
        self.disp.push(COMMAND, "juan", "canal", "foto", "pepe", "url3")
...
class TestGet(PluginTest):
    ...
    def test_noparams(self):
        """No parameters."""
        self.disp.push(COMMAND, "pepe", "canal", "foto")
        self.assertEqual(self.answer[0][1],
                         u"pepe: tell me the nick")

    def test_no_url(self):
        """No url configured."""
        self.disp.push(COMMAND, "pepe", "canal", "foto", "pepe")
        self.assertEqual(self.answer[0][1],
                         u"pepe: doesn't have configured URL")
    ...
    def test_url_other(self):
        ...
        self.disp.push(COMMAND, "juan", "canal", "foto", "juan", "url")
        self.disp.push(COMMAND, "pepe", "canal", "foto", "juan")
        self.assertEqual(self.answer[1][1], u"pepe: url")
    ...
    def test_url_mixed(self):
        ...
        self.disp.push(COMMAND, "juan", "canal", "foto", "juan")
        self.assertEqual(self.answer[4][1], u"juan: url1")
        self.disp.push(COMMAND, "juan", "canal", "foto", "pepe")
